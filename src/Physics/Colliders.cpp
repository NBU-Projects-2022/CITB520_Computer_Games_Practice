...
bool CheckForBoxWithBoxCollision(BoxCollider * b1, BoxCollider * b2) {
    auto b1Pos = b1->entity->get<PositionComponent>();
    auto b2Pos = b2->entity->get<PositionComponent>();
...
bool CheckForBoxWithCircleCollision(BoxCollider * box, CircleCollider * circle) {
    auto boxPosition = box->entity->get<PositionComponent>();
    auto circlePosition = circle->entity->get<PositionComponent>();
...
bool CheckForCircleWithCircleCollision(CircleCollider * c1, CircleCollider * c2) {
    auto c1Pos = c1->entity->get<PositionComponent>();
    auto c2Pos = c2->entity->get<PositionComponent>();
